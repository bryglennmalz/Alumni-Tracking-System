                ...
                <div class="row page-titles">
					...
					<div class="col-7">
                            <div class="card-body text-center">
                                ...
                                <?php //echo convert_string('decrypt', 'WHdoWVhBVmZaRzgzUGlwSk9Fa0tkQT09');?>
								<br><br><br><br>
                            </div>
                    </div>
					...
					<div class="col-5">
                        <div class="card">
                            <div class="card-body">
								...
								<form id="sign_in" class="form-horizontal form-material" method="POST">
									...
									<div class="form-group row">
										<label for="adminid" class="col-sm-3 text-right control-label col-form-label">Administrator ID*</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="adminid" name="adminid" placeholder="Administrator ID" required autofocus>
										</div>
									</div>
									<div class="form-group row">
										<label for="pass" class="col-sm-3 text-right control-label col-form-label">Password*</label>
										<div class="col-sm-9">
											<input type="password" class="form-control" id="pass" name="pword" placeholder="Password" required>
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group m-b-0">
										<div class="offset-sm-3 col-sm-9">
											<button type="submit" class="btn btn-info waves-effect waves-light m-t-10" name="login">Sign in</button>
										</div>
									</div>
							</form>
                            </div>
