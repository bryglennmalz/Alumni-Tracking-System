...
<head>
    ...
    <title>Website Visit Logs | CMU - Alumni Tracking And Information System</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="waves-effect waves-dark" href="../chart/charts-results-corner.php"" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Charts and Statistics</span></a>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Alumni Activity Logs</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="logs" class="table table-bordered table-striped cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                ...
                                <!--table id="user_data" class="table table-bordered table-striped cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $username = 'root';
                                        $password = '';
                                        $con = new PDO( 'mysql:host=127.0.0.1;dbname=alumnet', $username, $password );
                                        $stmt = $con ->prepare("SELECT * FROM admin_logs");
                                        $stmt->execute();
                                        while($row = $stmt->fetch()){
                                        ?>
                                            <tr>
                                                <td><?php echo convert_string('decrypt',$row['admin_id'])?></td>
                                                <td><?php echo convert_string('decrypt',$row['admin_id'])?></td>
                                                <td><?php echo convert_string('decrypt',$row['log_type'])?></td>
                                                <td><?php echo $row['description']?></td>
                                                <td><?php echo convert_string('decrypt',$row['datetime'])?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
    ...
    <script src="alogs/jsgrid-init.js"></script-->
	
	<script type="text/javascript" language="javascript" >
        $('#user_data').ddTableFilter();
        var base_url = window.location.origin;
            ...
            var dataTable = $('#logs').DataTable({
                ...
                "order":[],
                "ajax":{
                    url:base_url+"/alumni-e-network-5/Administrator/logs/admin/fetch.php",
                    type:"POST"
                }
