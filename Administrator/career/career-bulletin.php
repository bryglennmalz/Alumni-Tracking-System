                    ...
                    <div class="col-md-8 col-xlg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
								...
								<?php
									if($pdo_jpost==0){
										echo "There are zero available jobs posted as of this momment";
									}
									else{
										$j_post = "";
										foreach($jposts as $jp){
											...
											$posname = $jp['position'];
											$emptypeid = $jp['emp_type'];
											$senioritylevelid = $jp['senior_level'];
											$compname = $jp['comp_name'];
											$complocation = $jp['comp_loc'];
											$jobdescription = $jp['job_desc'];
											$jobrequirements = $jp['job_req'];
											$compoverview = $jp['comp_overview'];
											$email = $jp['email'];
											$contactno = $jp['cell_no'];
											$website = $jp['website'];
											$datetime = $jp['date_time'];
											$userid = $jp['alumni_id'];

											//Query Alumni who post
											$staffid = DB::query('SELECT * FROM alumni WHERE alumni_id = :userid', array(':userid' => $userid));
																...
																<div>
																	<table width='100%'; height = '100%';>
																		<tbody>
																			<tr>
																				<td>
																					<h3 class='card-title'>".$posname."</h3>
																				</td>
																			</tr>
																			<tr>
																				<td>
