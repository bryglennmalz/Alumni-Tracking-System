<?php 
	...
	if (isset($_GET['careerid'])){
		...
		//Certain forum query
		$jpost = DB::query('SELECT * FROM alumni.jobpost WHERE jobpost.jobid = :careerid', array(':careerid' => $_GET['careerid']));
		
		foreach($jpost as $jp){
			$jobid = $jp['jobid'];
			$posname = $jp['posname'];
			$emptypeid = $jp['emptypeid'];
			$senioritylevelid = $jp['senioritylevelid'];
			$compname = $jp['compname'];
			$complocation = $jp['complocation'];
			$jobdescription = $jp['jobdescription'];
			$jobrequirements = $jp['jobrequirements'];
			$compoverview = $jp['compoverview'];
			$email = $jp['email'];
			$contactno = $jp['contactno'];
			$website = $jp['website'];
			$datetime = $jp['datetime'];
			$userid = $jp['userid'];
		}
		
		//determine the author
		$staffid = DB::query('SELECT * FROM alumni.alumni WHERE id = :userid', array(':userid' => $userid));
...
<head>
    ...
    <title>Career | <?php echo $posname, " at ",  $compname; ?></title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
							<a class="waves-effect waves-dark active" href="career-bulletin.php" aria-expanded="false"><i class="mdi mdi-briefcase"></i><span class="hide-menu">Career Bulletin</span></a>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor"><?php echo $posname, " at ",  $compname; ?></h3>
						<h6><small><ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../dashboard/home.php">Home</a></li>
							<li class="breadcrumb-item"><a href="forum-corner.php">Career Bulletin</a></li>
                            <li class="breadcrumb-item active"><?php echo $posname, " at ",  $compname;?></li>
                        </ol></small></h6>
                    </div>
                </div>
                <!-- ============================================================== -->
											...
											<div>
												<table width="100%"; height = "100%";>
													<tbody>
														<tr>
															<td>
																<h1 class="card-title its-a-title"> <?php echo $posname;?> </h1>
																<h6 class="career-texts-2"><?php echo $compname, " - ", $complocation;?></h6>
																<hr>
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td>
																...
																<h6 class="career-texts"><?php echo $jobdescription;?></h6>
															</td>
														</tr>
														<tr>
															<td>
															...
															<td>
																<div class="row">
																	<div class="col-sm-6">
																		...
																		<h6 class="career-texts"><?php echo $emptypeid;?></h6>
																	</div>
																	<div class="col-sm-6">
																		<h5>Seniority Level</h5>
																		<h6 class="career-texts"><?php echo $senioritylevelid;?></h6>
																	</div>
																</div>
														...
														<tr>
															<td>
																...
																<h6 class="career-texts"><?php echo $jobrequirements;?></h6>
															</td>
														</tr>
														<tr>
															<td>
														...
														<tr>
															<td>
																<h5 class=""><?php echo $compname;?></h5>
																<h6 class="career-texts"><?php echo $complocation;?></h6>
															</td>
														</tr>
														<tr>
															<td>
														...
														<tr>
															<td>
																<div class="row">
																	<div class="col-sm-4">
																		Company Email
																		<h6 class="career-texts"><?php echo $email;?></h6>
																	</div>
																	<div class="col-sm-4">
																		Contact Number
																		<h6 class="career-texts"><?php echo $contactno;?></h6>
																	</div>
																	<div class="col-sm-4">
																		Website
																		<h6 class="career-texts"><?php echo $website;?></h6>
																	</div>
																</div>
															</td>
														</tr>
