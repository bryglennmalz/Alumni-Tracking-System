                                                            ...
                                                            <div class='card-body'>
                                                                <div>
                                                                    ...
                                                                    <footer class='text-right'>
                                                                        <p>
                                                                            <small>
                                                                                -  <i class='material-icons mdi mdi-poll-box' style='font-size: 21px;'> </i> "." 0 "."-
...
<!-- sample modal content -->
    ...
    <script type="text/javascript">
        ...
        /*$(document).on('submit', '#AddSurveyForm', function(event){
            ...
            {
                $.ajax({  
                    url:base_url+"/alumni-e-network-4/Administrator/research/php/add-survey-php.php", 
                    method:"POST",  
