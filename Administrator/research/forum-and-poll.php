<?php 
	...
	if(!Login::isloggedin()){
		...
		require 'php/forum-and-poll-query-php.php';
...
<head>
    ...
    <title>Forum Corner | CMU - Alumni Tracking And Information System</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
									...
									<ul>
										<li>
											<div class="drop-title">
												<a href="#" id="add_button" class="add_button waves-effect waves-light model_img img-responsive" alt="default" data-toggle="modal" data-target="#forumModal">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Forum and Poll</h3>
                    </div>
                    ...
                    <div class="col-md-8 col-xlg-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
								...
								<?php 
									if ($pdo_forum == 0){
										echo "There is no forum posted as of this moment.";
									}else{
										$f_post = "";
										foreach($forum as $f){
											$ids = convert_string('encrypt', $f['post_id']);
											$ftitle = $f['f_title'];
											$fdesc = $f['f_desc'];
                                            $datetime_post = $f['datetime_post'];
                                            $datetime_end = $f['datetime_end'];
											$type = $f['type'];
											//$staff = $f['admin_id'];
											
												//Number of likes query
												$cntlikes =("SELECT `forum_react`.f_react_id FROM alumni.`forum_react` WHERE `forum_react`.forum_id = :fid");
												
												$pdo_cntLikes_Res = $pdoConnect ->prepare($cntlikes);
												$pdoExec = $pdo_cntLikes_Res -> execute(array(':fid' => $id));
												$pdo_forum_likes = $pdo_cntLikes_Res->rowCount();
												
												//Number of comments query
												$cntcomments =("SELECT forum_comment.f_comment_id FROM forum_comment WHERE forum_comment.`forum-id` = :fid");
												
												$pdo_cntComment_Res = $pdoConnect ->prepare($cntcomments);
												$pdoExec = $pdo_cntComment_Res -> execute(array(':fid' => $id));
												$pdo_forum_comments = $pdo_cntComment_Res->rowCount();

                                                if($type == "Forum"){

                                                $f_post .= "<a href='forum-poll.php?postid=".$ids."' method='POST'>
                                                            <div class='card'>
                                                                <div class='card-body'>
                                                                    <div>
                                                                        ...
                                                                        <footer class='text-right'>
                                                                            <p>
                                                                                <small>
                                                                                    - ".$pdo_forum_likes." <i class='mdi mdi-thumb-up' style='font-size: 21px;'></i>  &nbsp &nbsp -
                                                                                    ".$pdo_forum_comments." <i class='mdi mdi-comment-text' style='font-size: 21px;'></i> 
                                                                                    &nbsp &nbsp &nbsp &nbsp - <i class='mdi  mdi-calendar-clock' style='font-size: 21px;'></i> ".date('F d, Y  h:i A', strtotime($datetime_post))."
                                                                                </small>
                                                                            </p>
                                                                        </footer>
                                                                    </div>
                                                ...
                                                $cntvotes =("SELECT forum_poll.`post_id` FROM `poll` WHERE `poll`.post_id = :pollid");
                                                
                                                $pdo_cntVotes_Res = $pdoConnect ->prepare($cntvotes);
                                                $pdoExec = $pdo_cntVotes_Res -> execute(array(':pollid' => convert_string('decrypt',$ids)));
                                                            ...
                                                            <div class='card-body'>
                                                                <div>
                                                                    ...
                                                                    <footer class='text-right'>
                                                                        <p>
                                                                            <small>
                                                                                - ".$pdo_forum_likes." <i class='mdi mdi-thumb-up' style='font-size: 21px;'></i> 
                                                                                - ".$pdo_forum_comments." <i class='mdi mdi-comment-text' style='font-size: 21px;'></i> 
                                                                                - ".$pdo_forum_votes." <i class='mdi mdi-poll-box' style='font-size: 21px;'></i> -
                                                                                 &nbsp &nbsp &nbsp &nbsp - <i class='mdi  mdi-calendar-clock' style='font-size: 21px;'></i> ".date('F d, Y  h:i A', strtotime($datetime_post))."
                                                                            </small>
                                                                        </p>
                                                                    </footer>
                        ...
                        <div class="card earning-widget">
                            ...
                            <div class="card-body b-t collapse show">
                                <table class="table v-middle no-border">
                                    <tbody>
                                        <tr>
                                            <td>No. of Forum Posted</td>
                                            <td align="right"><span class="label label-light-info"><?php echo $pdo_forum;?></span></td>
                                        </tr>
                                        <tr>
                                            <td>No. of Forum Likes</td>
                                            <td align="right"><span class="label label-light-success"><?php echo $pdo_forum_corner_likes;?></span></td>
                                        </tr>
                                        <tr>
                                            <td>No. of Forum Comments</td>
                                            <td align="right"><span class="label label-light-primary"><?php echo $pdo_forum_corner_comments;?></span></td>
                                        </tr>
                                        <tr>
                                            <td>No. of Alumni Forum Reactors</td>
                                            <td align="right"><span class="label label-light-warning"><?php echo $pdo_forum_corner_comments;?></span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
    ...
    <!-- Add Forum -->
    <div id="forumModal" class="modal fade forumModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form class="form center-block form-material" name="addForumForm" id="addForumForm" method="post" enctype = "multipart/form-data" class="l-form">
                    <div class="modal-body">
                        <br>
    ...
    <!-- Poll -->
    <div id="pollModal" class="modal fade pollModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!--Dynamically add POLL CHOICES-->
     ...
     $(document).ready(function(){  
          ...
          $(document).on('submit', '#addPollForm', function(event){
                ...
                {  
                    $.ajax({  
                        url:base_url+"/alumni-e-network-5/Administrator/research/php/post-poll-php.php", 
                        method:"POST",  
                        data:new FormData(this),
                        contentType:false,
                        processData:false,
