...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Add Administrator -->
                        <!-- ============================================================== -->
						<?php if ($ahead == convert_string('encrypt',"Administrator")){ ?>
                                ...
                                <div id="userModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
											...
											<form class="form center-block form-material" id="user_form" method="post" enctype = "multipart/form-data" class="l-form">
												<div class="modal-body">
                                                    ...
                                                    <div class="form-group form-group-lg">
                                                        <div class="form-line">
                                                            <label class="form-label">Administrative type</label>
                                                            <select name="admin-type" id="adminType" class="form-control" required/>
                                                                <option value=""></option>
    ...
    <script src="../../assets/plugins/dialogify/dist/dialogify.min.js"></script>
