...
<head>
    ...
    <title>Verify Admin Account - Alumni Tracking And Information System</title>
    <!-- Bootstrap Core CSS -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="u-text text-center">
                                                    ...
                                                    <p class="text-muted"><?php echo convert_string('decrypt', 'QXVOeUVyZjlxd2w2RUtTcytHYmpodz09');?></p>
                                                </div>
                                            
                                                <form id="admin_verification" class="form-horizontal form-material" method="POST">
                                                    ...
                                                    <div class="form-group m-b-0">
                                                        <div class="offset-sm-3 col-sm-9">
                                                            <input type="hidden" class="form-control" id="adminid" name="adminid" value="<?php echo $user_id;?>">
