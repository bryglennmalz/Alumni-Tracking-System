...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="row" id="validation">
                    <div class="col-12">
                        <div class="card wizard-content">
                            <div class="card-body">
                                <form id="AffiliationOrgForm" onsubmit="return false">
                                    <h1>Affiliations - Organizations</h1>
                                    <small>You can click skip if you a member in a certain organization.</small> <br>

                                    <div id="phase1">
                                        <br>
                                        <div id="organizations_div">
                                            <div id="organizations_div_yeah">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="alumniId">Organization name:</label>
                                                        <input type="text" class="form-control" id="orgName[]" name="orgName[]" oninput="this.className = ''"> 
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="alumniId">Position:</label>
                                                        <input type="text" class="form-control" id="orgPos[]" name="orgPos[]" oninput="this.className = ''"> 
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                                                <input type="hidden" name="operation" value="Add Organizations">
    ...
    <script> 
        var orgName, orgPos, mStatred, mEnded, yrStarted, yrEnded;

        function _(x){
            return document.getElementById(x);
        } 
        function submitForm(){
            orgName = _('orgName[]').value;
            orgPos = _('orgPos[]').value;
            ...
            else if (orgPos.length < 2){
                alert("Please enter the Organization position")
            }
            else if (mStatred.length < 0){
                alert("Please enter the Organization month joined");
                            }
            else if (yrStarted.length < 0){
                alert("Please enter the Organization year joined");
            }
            else if (mEnded.length < 0){
                alert("Please enter the Organization month ended");
            }
            else if (yrEnded.length < 0){
                alert("Please enter the Organization year ended");
            }
            else if (orgName.length > 2 && orgPos.length > 2 && mStatred.length > 0 && yrStarted.length > 0 && mEnded.length > 0 && yrEnded.length > 0){
                _("AffiliationOrgForm").method = "post";
                _("AffiliationOrgForm").action = "php/signup-affiliations-organizations-php.php";
                _("AffiliationOrgForm").submit();

            }
        }
        function processPhaseBack3(){
                _("AffiliationOrgForm").method = "post";
                _("AffiliationOrgForm").action = "signup-affiliations-seminars-trainings-workshops.php";
                _("AffiliationOrgForm").submit();
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        $('#addInfo').click(function(){ 
            ...
            $('#organizations_div_yeah').append(q);      
            i++;  
        });
