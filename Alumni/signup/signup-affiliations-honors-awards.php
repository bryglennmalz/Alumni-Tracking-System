...
<body class="fix-header fix-sidebar card-no-border">
                ...
                <div class="row" id="validation">
                    <div class="col-12">
                        <div class="card wizard-content">
                            <div class="card-body">
                                <form id="HonorsAwardsForm" onsubmit="return false">
                                    <h1>Affiliations - Honors and Awards</h1>
                                    <small>You can click skip if you do not have award/honors recieved or if you do not want to share your information.</small> <br>

                                    <div id="phase1">
                                        <br>
                                        <div id="honors_awards_div">
                                            <div id="honors_awards_div_yeah">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="alumniId">Honor/Award name: <span class="danger">*</span></label>
                                                        <input type="text" class="form-control" id="haName[]" name="haName[]" oninput="this.className = ''"> 
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="alumniId">Associated:</label>
                                                        <input type="text" class="form-control" id="haAssoc[]" name="haAssoc[]" oninput="this.className = ''"> 
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="alumniId">Issuer: <span class="danger">*</span></label>
                                                        <input type="text" class="form-control" id="haIssuer[]" name="haIssuer[]" oninput="this.className = ''"> 
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="firstName"> Month: <span class="danger">*</span> </label>
                                                                <select class="form-control" id="haMonth[]" name="haMonth[]" oninput="this.className = ''" required>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="haYear[]" name="haYear[]" oninput="this.className = ''" required>
                                    ...
                                    <div class="form-group">
                                        <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                                            <input type="hidden" name="operation" value="Add Honors or Awards">
    ...
    <script> 
        var haName, haAssoc, haIssuer, haMonth, haYear;
        ...
        function submitForm(){
            haName = _('haName[]').value;
            haAssoc = _('haAssoc[]').value;
            haIssuer = _('haIssuer[]').value;
            haMonth = _('haMonth[]').value;
            haYear = _('haYear[]').value;
            if(haName.length < 2){
                alert("Please enter the Honor or Award title");
            }
            else if (haAssoc.length < 1){
                alert("Please enter the Honor or Award associated");
            }
            else if (haIssuer.length < 1){
                alert("Please enter the Honor or Award issuer");
            }
            else if (haMonth.length < 1){
                alert("Please enter the Honor or Award month recieved");
            }
            else if (haYear.length < 1){
                alert("Please enter the Honor or Award year recieved");
            }
            else if (haName.length > 2 && haAssoc.length > 1 && haIssuer.length > 2 && haMonth.length > 0 && haYear.length > 0){
                _("HonorsAwardsForm").method = "post";
                _("HonorsAwardsForm").action = "php/signup-affiliations-honor-award-php.php";
                _("HonorsAwardsForm").submit();

            }
        }
        function processPhaseBack3(){
                _("HonorsAwardsForm").method = "post";
                _("HonorsAwardsForm").action = "signup-others.php";
                _("HonorsAwardsForm").submit();
        }
    </script>
    ...
    <script type="text/javascript">
        ...
        $('#addInfo').click(function(){ 
            ...
            $('#honors_awards_div_yeah').append(q);      
            i++;  
        });
