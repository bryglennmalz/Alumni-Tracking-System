...
<head>
    ...
    <title>Signup Other Information | CMU - Alumni Tracking And Information System</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-devider"></li>
                        <li> 
                            <span class="hide-menu" style="color: #14d26e;">Other</span>
                        </li>
                        <li class="nav-devider"></li>
                ...
                <div class="row" id="validation">
                    <div class="col-12">
                        <div class="card wizard-content">
                            <div class="card-body">
                                <form id="OtherForm"  onsubmit="return false">
                                    <h1>Other</h1>
                                     <br>
                                    ...
                                    <div id="phase1">
                                        <br>
                                        <div id="other_div">
                                            <div id="other_div_yeah">
                                                <div class="col-md-12">
                                                    <div class="profile_center" style="margin:auto; width:70%; padding: 0px">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Change profile picture</h4>
                                                            <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/images/users/user.png" />
                                                        </div>
                                                    </div>
                                                    <hr>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                                            <input type="hidden" name="operation" value="Add Profile Picture">
                                            <button type="button" class="btn btn-secondary" name="skip" onclick="processPhaseBack3()">Skip</button>
                                             <input type="hidden" id="alumniid" name="alumniid" value="<?php echo Login::isloggedin();?>">
    ...
    <script> 
        ...
        function submitForm(){
                _("OtherForm").method = "post";
                _("OtherForm").action = "php/signup-others-php.php";
                _("OtherForm").submit();
        }
        function processPhaseBack3(){
            alumniid = _('alumniid').value;
                _("OtherForm").method = "post";
                _("OtherForm").action = "../account/profile.php?alumniid="+alumniid;
                _("OtherForm").submit();
        }
    </script>
