            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url(../../assets/images/background/user-info.jpg) no-repeat;">
                    ...
                    <div class="profile-text"> 
						<a href="#"><?php echo $alfname, ' ', $almname, ' ', $allname, ' ', $alextname;?></a>
                    </div>
                </div>
                ...
                <div class="row" id="validation">
                    <div class="col-12">
                        <div class="card wizard-content">
                            <div class="card-body">
								<form id="BasicInfoForm" method="POST" action="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="alumniId" name="alumniId" value="<?php echo $id;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
                                        </div>
										<hr>
										<div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required" id="firstName" name="firstName" value="<?php echo $fname;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="middleInitial"> Middle Name : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control required" id="middleInitial" name="middleInitial" value="<?php echo $mname;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="lastName"> Last Name : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control required" id="lastName" name="lastName" value="<?php echo $lname;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="extName"> Extension Name :</label>
                                                    <input type="text" class="form-control" id="extName" name="extName" value="<?php echo $extname;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
                                        </div>
										<hr>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control required" id="emailAddress" name="emailAddress" value="<?php echo $email;?>" oninput="this.className = ''" readonly> </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="phoneNo">Phone Number :</label>
                                                    <input type="tel" class="form-control" id="phoneNo" name="phoneNo" oninput="this.className = ''"> </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="telephoneNo">Telephone Number :</label>
                                                    <input type="tel" class="form-control" id="telephoneNo" name="telephoneNo" oninput="this.className = ''"> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
										...
										<div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="h-other" name="h-other" oninput="this.className = ''" required> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="cityMun"> Select Municipality/City : <span class="danger">*</span> </label>
                                                    <select class="form-control" id="h-cityMun" name="h-cityMun" oninput="this.className = ''" required>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="h-provinceState" name="h-provinceState" oninput="this.className = ''" required>
                                                        <option value="">Select City</option>
                                                        <option value="India">India</option>
                                                        <option value="USA">USA</option>
                                                        <option value="Dubai">Dubai</option>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="h-country" name="h-country" oninput="this.className = ''" required>
                                                        <option value="">Select City</option>
                                                        <option value="India">India</option>
                                                        <option value="USA">USA</option>
                                                        <option value="Dubai">Dubai</option>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="h-zipCode" name="h-zipCode" oninput="this.className = ''" required> </div>
                                            </div>
                                        </div>
										<hr>
										<div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="other"> Street name, : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control" id="c-other" name="c-other" oninput="this.className = ''" required> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="cityMun"> Select Municipality/City : <span class="danger">*</span> </label>
                                                    <select class="form-control" id="c-cityMun" name="c-cityMun" oninput="this.className = ''" required>
                                                        <option value="">Select City</option>
                                                        <option value="India">India</option>
                                                        <option value="USA">USA</option>
                                                        <option value="Dubai">Dubai</option>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="provinceState"> Select Province/State : <span class="danger">*</span> </label>
                                                    <select class="form-control" id="c-provinceState" name="c-provinceState" oninput="this.className = ''" required>
                                                        <option value="">Select City</option>
                                                        <option value="India">India</option>
                                                        <option value="USA">USA</option>
                                                        <option value="Dubai">Dubai</option>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="country"> Select Country : <span class="danger">*</span> </label>
                                                    <select class="form-control" id="c-country" name="c-country" oninput="this.className = ''" required>
                                                        <option value="">Select City</option>
                                                        <option value="India">India</option>
                                                        <option value="USA">USA</option>
                                                        <option value="Dubai">Dubai</option>
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="zipCode"> Zip Code : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control" id="c-zipCode" name="c-zipCode" oninput="this.className = ''" required> </div>
                                            </div>
                                        </div>
									</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
                                                <table class="table table-bordered" id="dynamic_field_Skill">  
													...
													<tr>  
														<td style=" width: 90%">
															<input type="text" id="skill[]" name="skill[]" placeholder="Skill" class="form-control name_list" oninput="this.className = ''" required/>
															<select class="form-control" id="langProf" name="langProf" oninput="this.className = ''" required>
																<option value="">Select Proficiency</option>
										...
										<div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group">
													...
													<input type="text" class="form-control required" id="sex" name="sex" value="<?php echo $sex;?>" oninput="this.className = ''" readonly> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="telephoneNo">Nationality :</label>
                                                    <input type="tel" class="form-control" id="telephoneNo" name="nationality" oninput="this.className = ''"> 
												</div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="googlePlus"> Ethnicity :</label>
                                                    <input type="email" class="form-control" id="googlePlus" name="ethnicity" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="facebook"> Religion :</label>
                                                    <input type="email" class="form-control" id="facebook" name="religion" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="instagram"> Father/Guardian's Name :</label>
                                                    <input type="email" class="form-control" id="instagram" name="fathername" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="linkedin"> Father/Guardian's Occupation :</label>
                                                    <input type="email" class="form-control" id="linkedin" name="fatherocc" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="twitter"> Mother's Name :</label>
                                                    <input type="email" class="form-control" id="twitter" name="mothername" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="website"> Mother's Occupation :</label>
                                                    <input type="email" class="form-control" id="website" name="motherocc" oninput="this.className = ''"> 
												</div>
                                            </div>
											<div class="col-md-12">
