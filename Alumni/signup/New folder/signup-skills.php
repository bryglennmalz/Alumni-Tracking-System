                    ...
                    <div class="col-md-12 contents">
						...
						<article class="wow fadeInDown opportunity-corner" data-wow-delay=".3s" data-wow-duration="500ms">
							<div class="settings-title text-center">
                                <h2 class="settings-title">STEP 8 OF 11: SKILLS</h2>
                            </div>
							<br>
							<br>
						</article>
						...
						<form action="#" class="form center-block" method="post" class="l-form">
							<?php include ('../php/signup-skills-php.php') ;?>
						
						<div class = "row panel skillTable">
												...
												<div class = "row col-sm-12">
													<div class="row">
														<div class="description col-sm-12">
															<b>Skill:</b>  <i>*</i><input type="text" name="skill-name[]" placeholder="Please input your Skill..." class="r-form-major form-control" spellcheck="false" required>
														</div>
													</div>
													<br>
												</div>
						...
						<div class="col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".9s"">	
							<br>
							<p> 
								<input type="button" value="Add Skill" onClick="addRow('dataTable')" /> 
								<input type="button" value="Remove Skill" onClick="deleteRow('dataTable')"  /> 
						...
						<div class="col-sm-6 wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".9s" style = "text-align:right;">
							<br>
							<input type = "submit" class="btn btn-primary btn-sm" name="submit-signup-skills" value="Save and Go to Next Step"></input>
							<br>
							<br>
							<br>
							<br>
