<?php 
	...
	if(!Login::isloggedin()){
        ...
        if(DB::query('SELECT * FROM alumni WHERE alumni_id=:alumniid AND verified=0', array(':alumniid'=>Login::isloggedin()))){
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/profile.png" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo convert_string('decrypt', $alfname) , ' ', convert_string('decrypt', $almname), ' ', convert_string('decrypt', $allname), ' ', convert_string('decrypt', $alextname);?></h4>
                            ...
                            <div class="card-body"> 
								<div class="row text-center justify-content-md-center">
									<a class="btn btn-secondary form-control" href = "account/profile.php?alumniid=<?php echo $alid;?>"><h5><i class="mdi mdi-account"></i> View Profile </h5></a>
								</div>
								<div>
									<br>
								</div>
								<div class="row text-center justify-content-md-center">
									<a class="btn btn-secondary form-control" href = "research/alumni-survey.php"><h5><i class="mdi mdi-account"></i> Take a Survey </h5></a>
								</div>
								<div>
									<br>
								</div>
								<div class="row text-center justify-content-md-center">
                                        <?php
                                            if($fb != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$fb.'"><i class="fa fa-facebook"></i></a>';
                                            }
                                            if($google != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$google.'"><i class="fa fa-google-plus"></i></a>';
                                            }
                                            if($ig != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$ig.'"><i class="fa fa-instagram"></i></a>';
                                            }
                                            if($linkedin != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$linkedin.'"><i class="fa fa-linkedin"></i></a>';
                                            }
                                            if($twitter != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$twitter.'"><i class="fa fa-twitter"></i></a>';
                                            }
                                            if($website != ""){
                                                echo '<a class="btn btn-circle btn-secondary" href = "'.$website.'"><i class="fa fa-globe"></i></a>';
                                            }
                                        ?>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Notification</a> </li>
                            </ul>
                            <!-- Tab panes -->
                                ...
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="card-body">
                                        <div class="profiletimeline">
											You have 0 notification as of this moment.
                                        </div>
                                    </div>
                                </div>
                            </div>
