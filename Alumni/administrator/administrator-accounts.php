											...
											<form class="form center-block floating-labels" method="post" enctype = "multipart/form-data" class="l-form">
												<div class="modal-body">
													...
													<div class="form-group form-float form-group-lg">
														<div class="form-line">
															<input type="text" name="admin-id" class="form-control" required/>
													...
													<div class="form-group form-float form-group-lg">
														<div class="form-line">
															<input type="password" name="p-word" class="form-control" required/>
															<label class="form-label">Password</label>
														</div>
													</div>
												</div>
												<div class="modal-footer">
													<button type = "submit" class="btn btn-outline-primary waves-effect text-left" name="AdminSave">Save</button>
										...
										<div class="table-responsive">
												...
												<table class="table table-bordered table-hover">
													<thead>
														<tr>
															...
															<th style=" width: 50%"><b>Fullname</b></th>
															<th style=" width: 30%"><b>Remarks</b></th>
														...
														<?php
															...
															foreach($staffs as $st){
																...
																if ($adtype == 1){
																	if($adhead == 1){
																		$verifieds = "";
																		$verifieds = "Verified, Super Administrator";
																	} else {
																		$verifieds = "";
																		$verifieds = "Verified, Administrator";
																	}
																} else{
																	$verifieds = "";
											...
											<?php } else {?>
												<table class="table table-bordered table-hover">
													<thead>
														<tr>
															<th style=" width: 30%"><b>ID</b></th>
															<th style=" width: 50%"><b>Fullname</b></th>
															<th style=" width: 20%"><b>Remarks</b></th>
														</tr>
													</thead>
													<tbody>
														<?php
