            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Forum Corner</h3>
                    </div>
											...
											<form class="form center-block floating-labels" method="post" enctype = "multipart/form-data" class="l-form">
												<div class="modal-body">
													...
													<div class="form-group form-float form-group-lg">
														<div class="form-line">
															<input type="text" name="forum-title" class="form-control" required/>
															<label class="form-label">Forum Title</label>
														</div>
													</div>
													<div class="form-group">
														<div class="form-line">
															<textarea rows="1" name="forum-desc" class="form-control no-resize auto-growth" required></textarea>
															<label class="form-label">Forum Description</label>
														</div>
													</div>
												</div>
												<div class="modal-footer">
													<button type = "submit" class="btn btn-outline-primary waves-effect text-left" name="ForumPost">POST</button>
								...
								<?php 
									if ($pdo_forum == 0){
										...
										foreach($forum as $f){
											...
											$f_post .= "<a href='forum.php?forumid=".$id."' method='POST'>
															<div class='card'>
																<div class='card-body'>
																	<div>
																		...
																		<footer class='text-right'>
																			<p>
																				<small>
																					- ".$pdo_forum_likes." <i class='material-icons'>thumb_up</i> -
																					".$pdo_forum_comments." <i class='material-icons'>comment</i> 
																					&nbsp &nbsp &nbsp &nbsp - ".date('F d, Y  h:i A', strtotime($datetime))."
																				</small>
																			</p>
																		</footer>
																	</div>
